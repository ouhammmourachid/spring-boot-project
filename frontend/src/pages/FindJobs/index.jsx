...
function FindJobs(){
    return (
    <div className="flex flex-col  items-center dark:bg-colordark min-h-screen">
        <form className="flex items-center w-1/2 mt-20">   
    ...
    <div className="relative w-full ">
        ...
        <input type="text" id="what" className="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-14 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 outline-none" placeholder="city or region"/>
