        ...
        <div class="shadow overflow-hidden">
          <div class="px-4 py-5 bg-white sm:p-6">
            <div class="flex flex-wrap p-3">
              ...
              <div class="col-span-6 m-3">
                <label for="city_or_state" class="block text-sm font-medium text-gray-700">City / State</label>
              ...
              <div class="m-3 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md w-96">
